...
public class User implements UserDetails, Serializable {
    ...
    public boolean equals(Object o) {
        ...
        User user = (User) o;
        return accountNonExpired == user.accountNonExpired && accountNonLocked == user.accountNonLocked && credentialsNonExpired == user.credentialsNonExpired && enabled == user.enabled && id.equals(user.id) && userName.equals(user.userName) && fullName.equals(user.fullName) && password.equals(user.password) && permissions.equals(user.permissions);
    }
